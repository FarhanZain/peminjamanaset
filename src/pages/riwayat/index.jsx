        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-3 lg:gap-4">
            <CardRiwayat
              ...
              statusAset="Konfirmasi Peminjaman"
              durasiPinjam="14 Mar 2024 - 15 Mar 2024"
            ></CardRiwayat>
            <CardRiwayat
              fotoAset="/image/logo.png"
              namaAset="Speaker Portable"
              unitAset="Unit SD"
              statusAset="Scan QR Aset"
              durasiPinjam="12 Mar 2024 - 13 Mar 2024"
            ></CardRiwayat>
            <CardRiwayat
              fotoAset="/image/logo.png"
              namaAset="Speaker Portable"
              ...
              durasiPinjam="10 Mar 2024 - 11 Mar 2024"
            ></CardRiwayat>
            <CardRiwayat
              fotoAset="/image/logo.png"
              namaAset="Speaker Portable"
              unitAset="Unit SD"
              statusAset="Konfirmasi Pengembalian"
              durasiPinjam="8 Mar 2024 - 9 Mar 2024"
            ></CardRiwayat>
          </div>
        </div>
      </div>
