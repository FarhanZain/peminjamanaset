    ...
    <div className="relative">
      ...
      >
        ...
        <span className="w-12 h-12 flex justify-center items-center rounded-full">
          <FaRegCircleUser size={35} color="grey" />
        </span>
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-60 flex-col rounded-xl border border-stroke bg-white ${
      ...
      >
        <ul className="flex flex-col gap-5 px-6 border-b border-stroke py-7">
          <li>
            <button
              className="flex items-center gap-3 text-sm font-medium duration-300 ease-in-out hover:text-orange-500 lg:text-base"
              onClick={() => {
                router.push("/admin/akun_admin");
              }}
            >
              <svg
